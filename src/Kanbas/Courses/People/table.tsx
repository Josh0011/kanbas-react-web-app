        ...
        <div id="wd-people-table">
            <table className="table table-striped">
                ...
                <tr>
                    ...
                    <td className="wd-login-id">0012345293</td>
                    <td className="wd-section">S101</td>
                    <td className="wd-role">STUDENT</td>
                    <td className="wd-last-activity">2020-10-01</td>
                    <td className="wd-total-activity">10:21:32</td>
                ...
                <tr>
                    <td className="wd-full-name text-nowrap">
                        ...
                        <span className="wd-last-name">Ramanoff</span></td>
                    <td className="wd-login-id">017274561S</td>
                    <td className="wd-section">S101</td>
                    <td className="wd-role">STUDENT</td>
                    <td className="wd-last-activity">2023-11-21</td>
                    <td className="wd-total-activity">5:11:12</td>
                </tr>
                </tbody>
            </table>
        </div>);
